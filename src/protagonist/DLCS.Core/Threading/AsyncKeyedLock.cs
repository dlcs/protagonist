...
public sealed class AsyncKeyedLock : IKeyedLock
{
    /// <summary>
    ...
    /// <param name="cancellationToken">async CancellationToken</param>
    /// <returns><see cref="Releaser"/> object</returns>
    public async Task<ILock> LockAsync(object key, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">async CancellationToken</param>
    /// <returns><see cref="Releaser"/> object</returns>
    public async Task<ILock> LockAsync(object key, TimeSpan timeout, bool throwIfNoLock = false,
        CancellationToken cancellationToken = default)
    {
        ...
        return new Releaser { Key = key, ExclusiveLock = success };
    }
    ...
    public sealed class Releaser : ILock
    {
