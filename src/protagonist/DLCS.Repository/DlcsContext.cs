...
public partial class DlcsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        PopulateDeliveryChannelPoliciesTable(modelBuilder);

        PopulateDefaultDeliveryChannelsTable(modelBuilder);

        OnModelCreatingPartial(modelBuilder);
    }

    private void PopulateDefaultDeliveryChannelsTable(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DefaultDeliveryChannel>().HasData(
            new DefaultDeliveryChannel
            {
                Id = Guid.NewGuid(), Customer = 1, Space = 0, MediaType = "image/*",
            ...
            new DefaultDeliveryChannel
            {
                Id = Guid.NewGuid(), Customer = 1, Space = 0, MediaType = "application/*",
                DeliveryChannelPolicyId = 4
            },
            new DefaultDeliveryChannel
            {
                Id = Guid.NewGuid(), Customer = 1, Space = 0, MediaType = "audio/*",
                DeliveryChannelPolicyId = 5
            },
            new DefaultDeliveryChannel
            {
                Id = Guid.NewGuid(), Customer = 1, Space = 0, MediaType = "video/*",
                DeliveryChannelPolicyId = 6
            }
        );
    }

    private static void PopulateDeliveryChannelPoliciesTable(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DeliveryChannelPolicy>().HasData(
            new DeliveryChannelPolicy
            {
                Id = 1, Name = "default", DisplayName = "A default image policy", Customer = 1, Channel = "iiif-img",
                System = true, Created = DateTime.UtcNow, Modified = DateTime.UtcNow
            },
            new DeliveryChannelPolicy
            {
                Id = 2, Name = "use-original", DisplayName = "Use original at Image Server", Customer = 1, 
                Channel = "iiif-img", System = true, Created = DateTime.UtcNow, Modified = DateTime.UtcNow
            },
            new DeliveryChannelPolicy
            {
                Id = 3, Name = "default", DisplayName = "A default thumbs policy", Customer = 1, Channel = "thumbs",
                System = false, Created = DateTime.UtcNow, Modified = DateTime.UtcNow,
                PolicyData = "[\"!1024,1024\", \"!400,400\", \"!200,200\", \"!100,100\"]"
            },
            new DeliveryChannelPolicy
            {
                Id = 4, Name = "none", DisplayName = "No transformations", Customer = 1, Channel = "file",
                System = true, Created = DateTime.UtcNow, Modified = DateTime.UtcNow
            },
            new DeliveryChannelPolicy
            {
                Id = 5, Name = "default-audio", DisplayName = "A default audio policy", Customer = 1,
                Channel = "iiif-av", System = false, Created = DateTime.UtcNow, Modified = DateTime.UtcNow,
                PolicyData = "[\"audio-aac-192\"]"
            },
            new DeliveryChannelPolicy
            {
                Id = 6, Name = "default-video", DisplayName = "A default video policy", Customer = 1, 
                Channel = "iiif-av", System = false, Created = DateTime.UtcNow, Modified = DateTime.UtcNow,
                PolicyData = "[\"video-mp4-720p\"]"
            },
            new DeliveryChannelPolicy // TODO: check this delivery channel policy is needed
            {
                Id = 7, Name = "none", DisplayName = "Empty channel", Customer = 1, Channel = "none",
                System = true, Created = DateTime.UtcNow, Modified = DateTime.UtcNow
            }
        );
    }
