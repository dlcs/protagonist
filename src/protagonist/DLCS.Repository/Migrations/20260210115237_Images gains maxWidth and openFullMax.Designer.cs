...
namespace DLCS.Repository.Migrations
{
    ...
    [Migration("20260210115237_Images gains maxWidth and openFullMax")]
    partial class ImagesgainsmaxWidthandopenFullMax
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DLCS.Model.Assets.Asset", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("Manifests")
                        .HasColumnType("text[]");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Manifests"), "gin");
            ...
            modelBuilder.Entity("DLCS.Model.Assets.BatchAsset", b =>
                {
                    ...
                    b.HasOne("DLCS.Model.Assets.Batch", "Batch")
                        .WithMany("BatchAssets")
            ...
            modelBuilder.Entity("DLCS.Model.Assets.ImageDeliveryChannel", b =>
                {
                    ...
                    b.HasOne("DLCS.Model.Assets.Asset", null)
