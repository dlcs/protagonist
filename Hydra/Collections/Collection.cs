...
{
    /// <summary>
    /// This doesn't have to be all the same type. But usually will be. If you really have to mix, use object.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class Collection<T> : JSONLDBaseWithHydraContext
    {
